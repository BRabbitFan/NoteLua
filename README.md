...
- [面向对象](Note/6.1.面向对象.md)
  - [利用元表实现OOP](Note/6.1.面向对象.md/#利用元表实现OOP)
  - [利用表克隆函数实现OOP](Note/6.1.面向对象.md/#利用表克隆函数实现OOP)
  - [利用闭合函数实现OOP](Note/6.1.面向对象.md/#利用闭合函数实现OOP)
- [文件操作](Note/6.2.文件操作.md)
  - [简单模式](Note/6.2.文件操作.md/#简单模式)
  - [完全模式](Note/6.2.文件操作.md/#完全模式)
---
